...
export const fetchInvoicesByUser = (searchQuery) => API.get(`/invoices?searchQuery=${searchQuery}`);
...
export const fetchClientsByUser = (searchQuery) => API.get(`/clients/user?searchQuery=${searchQuery}`);


export const fetchProduct = (id) => API.get(`/product/${id}`);
export const addProduct =( product ) => API.post('/product/create', product)
export const updateProduct = (id, updateProduct) => API.patch(`/product/update/${id}`, updateProduct)
export const deleteProduct =(id) => API.delete(`/product/delete/${id}`)
export const fetchProductByUser = (searchQuery) => API.get(`/product?searchQuery=${searchQuery}`);
