...
export const getInvoicesByUser =(searchQuery) => async (dispatch) => {
    ...
    const  { data: { data } } = await api.fetchInvoicesByUser(searchQuery.search)
...
export const getInvoice = (id) => async (dispatch)=> {
    try {
        ...
        const businessDetails = await api.fetchProfilesByUser({search: process.env.REACT_APP_CLIENT_ID})
