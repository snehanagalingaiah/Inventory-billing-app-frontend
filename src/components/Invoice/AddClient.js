...
const AddClient = ({ setOpen, open }) => {
    ...
    const [clientData, setClientData] = useState({ name: '', email: '', phone: '', address: '', userId: [process.env.REACT_APP_CLIENT_ID] })
  ...
  const clear =() => {
    setClientData({ name: '', email: '', phone: '', address: '', userId: [process.env.REACT_APP_CLIENT_ID] })
  }
